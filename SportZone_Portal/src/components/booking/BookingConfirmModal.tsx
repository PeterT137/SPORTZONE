    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const bookingData = {
                ...
                guestEmail: booking.guestInfo?.guestEmail || "",
                ...
                discountId:
                    typeof selectedDiscountId === "number"
                        ...
                        : null,
                notes:
                    booking.guestInfo?.notes || "Đặt sân qua hệ thống online",
                depositAmount,
            };
            console.log("[DEBUG] bookingData gửi lên API:", bookingData);

            let apiUrl =
                "https://localhost:7057/api/Payment/calculate-and-pay";
                    ...
                    <div className="border-b pb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-900">
                                    {booking.guestInfo.guestEmail || "N/A"}
                                </p>
                            </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between">
                                <span>
                                    Tiền sân ({booking.slots.length} slot)
                                </span>
                            ...
                            <div className="mt-3 p-2 bg-yellow-50 border border-yellow-200 rounded text-xs text-yellow-800">
                                ...
                                <p>
                                    • Liên hệ với chủ sân để nhận lại tiền cọc.
                                    (SĐT:{" "}
                                    <strong style={{ color: "red" }}>
                                ...
                                <p>
                                    • Chi phí dịch vụ phát sinh sẽ được thanh
                                    toán tại cơ sở.
                                </p>
                            </div>
                        </div>
